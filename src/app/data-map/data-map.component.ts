...
export class DataMapComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    let groupData = [
      {
        "name": "less than 1 million cases",
        "color": '#00c853',
        "data": [
          {
            "title": "Afghanistan",
            "id": "AF",
            "customData": "0.5 million"
          },
          // {
          //   "title": "Bulgaria",
          //   "id": "BG",
      ...
      {
        "name": "Between 1 and 2 Million",
        "color": '#039be5',
        "data": [
          {
            "title": "Pakistan",
            "id": "PK", // With MapPolygonSeries.useGeodata = true, it will try and match this id, then apply the other properties as custom data
            "customData": "1 million"
          },
          //  {
          //   "title": "Ireland",
          //   "id": "IE",
      ...
      {
        "name": "More than 2 million",
        "color": '#b71c1c',
        "data": [
          {
            "title": "China",
            "id": "CN",
            "customData": "3.5 million"
          }
        ]
      }
    ];
    ...
    groupData.forEach(function (group) {
      ...
      // Tooltip
      mapPolygonTemplate.tooltipText = "{title} has recorded {customData} Corona Virus Cases"; // enables tooltip
